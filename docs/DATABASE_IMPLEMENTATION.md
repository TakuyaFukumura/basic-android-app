...
## 概要
本実装では、Roomライブラリを使用してSQLiteデータベースを統合し、初期値として登録される "world" という文字列をデータベースから取得して画面に表示します。
...
## エラーハンドリング
- データベースアクセス失敗時は "world" をデフォルト値として表示
- try-catch文による例外処理
